...
const SecondSlide = () => {
    ...
    return (
        <div className={`d-flex flex-column text-center justify-content-center ${cl.backImg2}`}>
            <div className="text-center text-white m-4">
                <h2>
                    Как это работает?
                </h2>
            </div>
        <div className={`w-100 d-flex py-3 align-items-center justify-content-around text-center`}>
            <div className="w-25 p-3 h-100 border-end border-2 bg-black bg-opacity-25">
                <img src={icon1} alt="" className="my-3"/>
                <h5>Вы хотите сделать заказ
                </h5>
                <span>
            ...
            <div className="w-25 p-3 h-100 border-end border-2 bg-black bg-opacity-25">
                ...
                <h5>
                    Выбираете в каталоге исполнителя
                </h5>
                <span>
                    Сравнивайте опыт исполнителей, стоимость сроки
                </span>
            </div>
            <div className="w-25 p-3 h-100 border-end border-2 bg-black bg-opacity-25">
            ...
            <div className="w-25 p-3 h-100 bg-black bg-opacity-25">
                ...
                <h5>Вы получаете результат, а исполнитель оплату
                </h5>
                <span>
                    Сравнивайте опыт исполнителей, стоимость сроки
                </span>
